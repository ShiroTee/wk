...
@Service
public class CenterTableInfoServiceImpl implements ICenterTableInfoService {
	...
	public PageList<Map<String, Object>> getTableNameListGroupByBM(int start,
		...
		String SQLStr1 = "SELECT t.wbjbm,t.wbjjc,COUNT(distinct(t.bm)) tablecount,NVL(SUM(o.addcount),0) addsum FROM DMP_WBJ_TABLE t LEFT JOIN (SELECT * FROM OLAP_CENTER_TABLE_COUNT ol ";
	...
	public List<Map<String, Object>> getOneTableInfoByBM(Model argsMap,
		...
		List<Map<String, Object>> list = null;
		StringBuffer sql = new StringBuffer();
		String SQLStr1 = "SELECT t.wbjbm,t.wbjjc,t.bhzmc,t.bm,NVL(SUM(t.addcount),0) addsum FROM (SELECT d.wbjbm WBJBM,d.wbjjc WBJJC,d.bhzmc BHZMC,d.bm BM,o.addcount ADDCOUNT,o.adddate ADDDATE FROM DMP_WBJ_TABLE d LEFT JOIN olap_center_table_count o ON d.wbjbm=o.wbjbm AND d.bm=o.bm WHERE d.wbjbm=? ";
	...
	public List<Map<String, Object>> getOneMonthAddByBM(Model argsMap,
		...
		List<Map<String, Object>> list = null;
		StringBuffer sql = new StringBuffer();
		sql.append("SELECT t.adddate,t.addcount FROM olap_center_table_count t WHERE t.wbjbm=? AND t.bm=? ");
