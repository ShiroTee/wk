...
@Component
public class WbjTableInfoHandler extends AbstractExtHandler {

	@Autowired
	private IWbjTableInfoService wBJTableInfoService;
	...
	public PageList<Map<String, Object>> getWBJTableInfo(Model argsMap) {
		...
		PageList<Map<String, Object>> pageList = wBJTableInfoService
	...
	public PageList<Map<String, Object>> getOneTableInfo(Model argsMap) {
		...
		String startDate = argsMap.getValue("starttime_date");
		String endDate = argsMap.getValue("endtime_date");
		list = wBJTableInfoService.getOneTableInfoByBM(argsMap);
		for (Map<String, Object> map : list) {
...
//		List<Map<String, Object>> list = null;
//		list = wBJTableInfoService.getOneMonthAddByBM(argsMap);
//		for (Map<String, Object> map : list) {
...
//	}
	...
	public PageList<WBJTableCountBean> getOneMonthAdd(Model argsMap) {
		PageList<WBJTableCountBean> list = this.wBJTableInfoService.getOneMonthAddByBM(argsMap);
        return list;
	}
	...
	{
		ViewModel viewModel=new ViewModel("dataproduce/pre-wbjdata.jsp");
		return viewModel;
	}
	...
	public String getRootData(Model argsMap) {
		List<DmpDmJhmodeBean> list = wBJTableInfoService.getWBJList();
