...
window.onload=function(){
	var data1 = "http://10.6.10.25:7001/bi/opencontrol.jsp?action=visitDirect.do&path=/共享报表/兰州数据中心/委办局前置与基础库对账&user=administrator&pwd=000000&params={[BI_DATE].time1}:{";
