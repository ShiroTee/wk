...
public abstract class BaseCmsUser  implements Serializable {
	...
	public static String RDP_USEID = "rdpUserId" ;//zhyg
	public static String RDP_PHONE_NUMBER = "rdpPhoneNumber" ;//zhyg
	public static String RDP_USER_ORG = "rdpUserOrg" ;//zhyg
	public static String RDP_USER_ORGID = "rdpUserOrgId" ;//zhyg
	...
	private java.lang.String rdpUserOrgId ;//zhyg	RDP用户机构ID
