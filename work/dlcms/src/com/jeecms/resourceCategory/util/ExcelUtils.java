...
public class ExcelUtils {
     ...
     * 导出数据
     * */
    public static Map<String,String> export(List<Map<String, Object>> dataList, String pathPrefixion, String title, String[] rowName,String[] rowCode) {

        SimpleDateFormat dateFormater=new SimpleDateFormat("yyyy年MM月dd日hh时mm分ss秒SSS");
        Date date=new Date();
        String time=dateFormater.format(date);

        String path = pathPrefixion+"/download/";
        ...
        try{
            ...
            for(int i=0;i<dataList.size();i++){
                ...
                for(int n=0;n<columnNum;n++){
                    ...
                    String value =StringUtils.objToString(map.get(rowCode[n]));
