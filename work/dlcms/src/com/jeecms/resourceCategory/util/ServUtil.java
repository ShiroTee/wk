...
public class ServUtil {
    ...
    public static String getServerId() {
        ServUtil sd = _instance;
        if (sd._serverId == null) {
            if (ServUtil.isGeronimo()) {
                sd._serverId = "geronimo";
            } else if (ServUtil.isJBoss()) {
                sd._serverId = "jboss";
            } else if (ServUtil.isJOnAS()) {
                sd._serverId = "jonas";
            } else if (ServUtil.isOC4J()) {
                sd._serverId = "oc4j";
            } else if (ServUtil.isOrion()) {
                sd._serverId = "orion";
            } else if (ServUtil.isResin()) {
                sd._serverId = "resin";
            } else if (ServUtil.isWebLogic()) {
                sd._serverId = "weblogic";
            } else if (ServUtil.isWebSphere()) {
    ...
    private static ServUtil _instance = new ServUtil();
