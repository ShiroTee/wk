...
public abstract class BaseUnifiedUser  implements Serializable {
	...
	public static String RDP_USEID = "rdpUserId" ;//
	public static String RDP_PHONE_NUMBER = "rdpPhoneNumber" ;//
	public static String RDP_USER_ORG = "rdpUserOrg" ;//
	public static String RDP_USER_ORGId = "rdpUserOrgId" ;//
	
	//public static String RDP_ java.lang.String rdpRole,	 
	//public static String RDP java.lang.String rdploginName
	...
	public BaseUnifiedUser (
		...
		java.lang.String rdpUserId,
		java.lang.String rdpPhoneNumber,
		java.lang.String rdpUserOrg,
		java.lang.String rdpUserOrgId,
		...
		this.setRdpUserId(rdpUserId) ;
		this.setRdpPhoneNumber(rdpPhoneNumber) ;
		this.setRdpUserOrg(rdpUserOrg) ;
		this.setRdpUserOrgId(rdpUserOrgId) ;
   ...
   */
	...
	private java.lang.String rdpUserId ;// RDP平台用户ID
	private java.lang.String rdpPhoneNumber ;//	RDP机构电话号码
	private java.lang.String rdpUserOrg ;//	RDP用户机构名称
	private java.lang.String rdpUserOrgId ;//RDP用户机构ID
