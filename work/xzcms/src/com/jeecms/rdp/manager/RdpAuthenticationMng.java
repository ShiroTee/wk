package com.jeecms.rdp.manager;
 ...
 * 
 */
public interface RdpAuthenticationMng {
	/**
	 * 认证信息session key
	 */
	public static final String AUTH_KEY = "auth_key";
	public static final String RDP_USER = "rdp_user";//rdp平台的用户对象
	...
	public Authentication login(String username, String ip,
			HttpServletRequest request, HttpServletResponse response,
			SessionProvider session,String loginType) throws UsernameNotFoundException,
			BadCredentialsException;
