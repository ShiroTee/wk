...
public class LuceneContent {
	...
	public static Query createQuery(String queryString, Integer siteId,
		...
		if (!StringUtils.isBlank(queryString)) {
			String[] wordArray = getWordArray(queryString,analyzer);
			for(int i = 0 ; i < wordArray.length ; i ++){
				q = MultiFieldQueryParser.parse(Version.LUCENE_36, wordArray[i],
	...
	//Add BY Xiao.luo 全站搜索mmseg4j分词
	private static String[] getWordArray(String queryString,Analyzer analyzer) {
		List<String> list = new ArrayList<String>();
		TokenStream tokenStream =analyzer.tokenStream("mmseg4jAnalyzer", new StringReader(queryString));
