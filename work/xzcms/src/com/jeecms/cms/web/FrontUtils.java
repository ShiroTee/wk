...
public class FrontUtils {
	...
	public static void frontData(HttpServletRequest request,
		...
		if (user != null) {
		    map.put(USER, request.getSession().getAttribute("rdp_user"));
		}
	...
	public static void frontData(Map<String, Object> map, CmsSite site,
		...
		//}
		map.put(SITE, site);
		String sss = site.getContextPath() ;
		...
		map.put("checkFlag", PropertiesUtil.getValueBykey("checkFlag"));
		map.put("pageSize", PropertiesUtil.getValueBykey("pageSize"));
		map.put("BIAdd", PropertiesUtil.getValueBykey("BIAdd"));
		map.put("platformAdd", PropertiesUtil.getValueBykey("platformAdd"));
		map.put("agentPlatformAdd", PropertiesUtil.getValueBykey("agentPlatformAdd"));
		map.put("gisDomain", PropertiesUtil.getValueBykey("gisDomain"));
		map.put("gisHtml", PropertiesUtil.getValueBykey("gisHtml"));
		map.put("gisUuid", PropertiesUtil.getValueBykey("gisUuid"));
		map.put("weatherIp", PropertiesUtil.getValueBykey("weatherIp"));
		map.put("biReportFileDirectoryName", PropertiesUtil.getValueBykey("biReportFileDirectoryName"));
		map.put("rootCode", PropertiesUtil.getValueBykey("rootCode"));
		map.put("biUserName", PropertiesUtil.getValueBykey("biUserName"));
		map.put("biPassword", PropertiesUtil.getValueBykey("biPassword"));
		map.put("biQueryStartDate", PropertiesUtil.getValueBykey("biQueryStartDate"));
		map.put("biQueryEndDate", PropertiesUtil.getValueBykey("biQueryEndDate").equals("now")?DateUtils.getDateByFormat("yyyy-MM-dd"):PropertiesUtil.getValueBykey("biQueryEndDate"));
