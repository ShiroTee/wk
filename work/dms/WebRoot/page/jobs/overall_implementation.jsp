...
window.onload=function(){
	var data1 = "http://10.6.10.25:7001/bi/opencontrol.jsp?action=visitDirect.do&path=/共享报表/兰州数据中心/作业整体执行情况统计&user=administrator&pwd=000000&params={[BI_DATE].time1}:{";
