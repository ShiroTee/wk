...
// 各种链接
var listUrl = "getTransLogManageList";
...
// 解决日期控件在IE浏览器下面上下显示不全的BUG
		Ext.override(Ext.menu.Menu,
	{
		...
		var resultStoreFields = [ 'idTransformation', 'name', 'createdUser', 'modifiedUser',
				'createdDate', 'modifiedDate', 'description', 'govName', 'stepName'];
...
//					}
	...
	function formatQtip(value, metadata, record, rowIndex, columnIndex, store)
	{
		...
		/** *****以下为注册各页面组件方法******************************* */
		// 提示标签提示的内容;
		setTip(" 对各委办局的流程设计中转换的创建、修改信息进行跟踪。");
