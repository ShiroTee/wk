...
<html>
  <head>
	...
	<link href="<%=request.getContextPath()%>/css/dms-echarts.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="esblogstatics1.js"></script>
  </head>
  
  <body>
    <div id="form" class="div1" style="width:100%; height:40px;">
    <form action="">
     <span class = "div-label">服务分类：
     <select class="div-select" id="ps5" name="ps5" onchange="changeServiceList()">
      <option value="" selected="selected">全部</option>
     </select>
     </span>
          <span class = "div-label">服务：
     <select class="div-select" id="ps6" name="ps6" >
      <option value="" selected="selected">全部</option>
     </select>
     </span>
