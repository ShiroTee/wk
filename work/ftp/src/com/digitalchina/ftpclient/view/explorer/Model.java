...
public class Model {
    ...
    public boolean getOnlyLocalPath() {
        return onlyLocalPath;
    }

    public void setOnlyLocalPath(boolean onlyLocalPath) {
        this.onlyLocalPath = onlyLocalPath;
    }

    private boolean onlyLocalPath=false;//本地文件路径
    private File[] localFiles; //本地文件列表

    public File[] getLocalTreeFiles() {
        return LocalTreeFiles;
    }

    public void setLocalTreeFiles(File[] localTreeFiles) {
        LocalTreeFiles = localTreeFiles;
    }

    private File[] LocalTreeFiles; //本地文件树
