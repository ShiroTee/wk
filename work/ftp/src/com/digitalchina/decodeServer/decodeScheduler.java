...
public class decodeScheduler {
	...
	static  Logger log4j = Logger.getLogger(decodeScheduler.class); 
	
	 public static void main(String[] args) throws  Exception {
		  //1、创建JobDetial对象 
		  
	      JobDetail job = newJob(decodeJob.class)
	      .withIdentity("job1", "group1")
	      .build();
	      
	      String	repeatInterval=ServerPropertiesUtil.getValueBykey("decodeRepeatInterval");//间隔时间
	      int repeatTime=60;
