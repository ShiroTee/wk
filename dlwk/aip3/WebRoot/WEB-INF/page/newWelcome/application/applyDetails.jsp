...
<mdp:newHeader title="资源申请-信息资产管理平台V3.0" curItem="" />
...
<section class="main_page">
	<div class="box mb20">
		<div class="cart_shopList" id="rc_CatalogList" style="background: inherit;">
			<label class="exam_check" style="cursor: default;border: 0;">
				<div class="cart_col1">
					<div class="cart_img">
		...
		<c:if test="${not empty reousrceOwnerApprovalNode and not empty reousrceOwnerApproval}">
			<div>
				...
				<div class="res_con">
					...
					<div class="res_labs" style="color: #999;">
						审批意见：<span style="color: #666;">${reousrceOwnerApproval.variableMap.acceptanceOpinion }</span>
					</div>
				</div>
				<div  class="res_con">
		...
		<c:if test="${not empty grantAuthorizationNode and not empty grantAuthorization }">
			<div>
				...
				<div class="res_con">
					...
					<div class="res_labs" style="color: #999;">
						授权意见：<span style="color: #666;">${grantAuthorization.variableMap.acceptanceOpinion }</span>
					</div>
				</div>
			</div>
		</c:if>
