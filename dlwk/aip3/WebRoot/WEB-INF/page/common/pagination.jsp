...
<link type="text/css" rel="stylesheet" href="${ctx}/resources/jquery/plugins/JqueryPagination/css/jquery.pagination.css"></link>
<script type="text/javascript" src="${ctx}/resources/jquery/plugins/JqueryPagination/js/jquery.pagination-1.2.7.min.js"></script>
...
<div id="q_listPagination"   class="m-pagination"   data-page-btn-count="10"
