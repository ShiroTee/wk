...
<link rel="stylesheet" href="${ctx }/page/welcome/api/css/details.css"/>  
<mdp:mdpHeader title="API详情" curItem="information"/>
<script>	
	$(function(){
...
<section class="main_page main_details">
	<!-- <a style="display:none;" class="go_back" href="javascript:void(0)" onclick="history.go(-1)"></a> -->
	<div>
		...
		<div class="btn_area">
			<a class="btn_gold pl15 mb15"><i class="icon_16 icon_application_white mr10"></i>立即申请</a>
			<a class="btn_gold pl15"><i class="icon_16 icon_basket_white mr10"></i>加入资源车</a>
		</div>
	</div>
	...
	<div class="tab_main">
		<div data-tab-item="document" class="tab_content">
			...
			<div class="tab_content_main">
				...
				<div style="width:100%;background: #F7F7F7;border-radius: 3px;padding: 18px 24px;
					min-height: 84px;line-height: 25px;">
    				<!-- <i class="copy r"></i> -->
		...
		<div data-tab-item="return_code" class="tab_content" style="display:none;">
			<div  class="tab_content_main">
				...
				<table width="780" border="0" cellspacing="0" cellpadding="0" class="table_cus">
					<tr>
						<th>错误码</th>
						<th>说明</th>
					</tr>
