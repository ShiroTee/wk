			...
			<div class="row title-banner">
				...
				<div class="title-box">
					<div class="titl-text-box title-small">
						<div class="title-ps">
							<span class="title-p-text">关注服务对象拥有的业务事项,点击空白区域可以拖动图形</span>
						</div>
						<div class="caozuoshuoming"></div>
						<div style="display: none;" class="caozuoshuoming-div">
							<p>操作说明：</br>
							1、点击空白区域，可以拖动图形。</br>
							2、点击服务对象分类，可以展开/收缩服务对象的子分类。</br>
							3、点击服务对象子分类可以展开/收缩服务对象子分类关联的业务事项。</br>
							4、点击业务事项可以查看业务事项关联信息资源、信息系统、业务事项的图形。</br>
							5、双击服务对象分类、子分类可以查看分类关联的业务事项及详情。</br>
							6、双击业务事项可以查看所选业务事项详情。</p>
						</div>
				    </div>
