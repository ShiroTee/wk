						...
						<div class="col-sm-12">
							<div class="tabbable">
								<ul class="nav nav-tabs" id="myTab">
									<li class="active"><a data-toggle="tab" href="#erm">
											信息资源管理 </a></li>

									<li><a data-toggle="tab" href="#resGroup"> 信息资源组成 <!-- <span class="badge badge-danger">4</span> -->
									</a></li>
								</ul>
								...
								<div class="tab-content">
									...
									<div id="resGroup" class="tab-pane fade">
										<div class="row">
											<div class="col-xs-6">
...
<script type="text/javascript"
	src="${ctx}/plugin/amp/page/views/detail/js/res-detail.js"></script>