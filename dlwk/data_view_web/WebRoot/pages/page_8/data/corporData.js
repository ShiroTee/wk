	...
	left : {
		...
		newIndustry : {
			data2010 : {
				...
				series_data_share : [(100*10/15).toFixed(2),(100*9/14).toFixed(2),(100*9/15).toFixed(2),(100*8/14).toFixed(2),(100*7/15).toFixed(2),(100*6/15).toFixed(2),(100*5/13).toFixed(2),(100*4/11).toFixed(2),(100*4/12).toFixed(2),(100*4/13).toFixed(2)]
			},
			data2015 : {
				xAxis_data : [
						"市文化广电新闻出版局",
						...
						"市金融工作办公室",
						"市食品药品监督管理局" ],
				series_data_share : [(100*1/8).toFixed(2),(100*1/9).toFixed(2),(100*1/10).toFixed(2),(100*1/11).toFixed(2),(100*1/13).toFixed(2),(100*1/17).toFixed(2),(100*1/19).toFixed(2),(100*1/20).toFixed(2),(100*1/21).toFixed(2),(100*1/22).toFixed(2)]
			} 
		},
		 //简单柱状图
		infoNeed: {
