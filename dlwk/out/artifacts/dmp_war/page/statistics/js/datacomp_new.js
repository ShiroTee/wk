...
var url = PROJECT_ROOT+"/app/http/dmp/compDataManHandler/getDataBarByDate?param_data=1";
var wbj_arr = [];
...
function showDataByWbj(param_wbjjc) {
	       ...
	       show_level = 2;
	       title = param_wbjjc+"-数据对比统计柱状图";
	       var wbj_last_url= PROJECT_ROOT+"/app/http/dmp/compDataManHandler/getDataBarByWbj?param_wbjjc="+encodeURI(encodeURI(param_wbjjc));
