...
<html>
  ...
  <body>
    ...
    <form action="">
     <span >截止日期：&nbsp;<input type="text" id="p5end" name="p5end" value=""  class="text"  onFocus="WdatePicker({dateFmt:'yyyy-MM'})"/></span>
...
<script type="text/javascript" src="js/statisticsbasedata_new.js"></script>
  </body>
</html>
