...
<mdp:mdpHeader title="应用成果示范"  curItem="information"/>
<section class="main_page">	
    ...
    <div  style="display: inline-block;position: relative;">
		...
		<a target="_blank" class="card l"  href="${ctx }/page/welcome/xuzhou_app/index.html">
			<!-- <div class="todo">
				<div>
			...
			<div class="title api">徐州数据中心项目</div>
			<i class="icon_time">2017/04/14</i>
			<i class="icon_download">4,211</i>
		</a>
		<a target="_blank" class="card l"  href="${ctx }/page/welcome/changshu_app/index.html">
			<!-- <div class="todo">
				<div>
					<a class="show_detail icon_detail">查看详情</a>
				</div>
			...
			<div class="title api">常熟数据中心项目</div>
			<i class="icon_time">2017/04/14</i>
			<i class="icon_download">4,211</i>
		</a>		
	</div>
