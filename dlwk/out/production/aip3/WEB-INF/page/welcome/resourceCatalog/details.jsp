...
<link rel="stylesheet" href="${ctx }/page/welcome/resourceCatalog/css/details.css"/> 
<script type="text/javascript"
	src="${ctx}/page/welcome/application/js/cookieUtils.js"></script>
<mdp:mdpHeader title="-" curItem="mulu"/>
<script>	
	$(function(){
	...
	function get_routeDetails(routeid){
		$.ajax({
			...
			success : function(data){
				...
				$("#gxjb_routeDetails").html(data[0].publicLv.publicLvName);
				var finalUpdateTime = '-';
...
<section class="main_page main_details">
	<!-- <a class="go_back" href="javascript:void(0);"  onclick="aclick();"></a> -->
	<div>
		...
		<div class="btn_area">
			<a class="btn_gold pl15 mb15" onclick="buyNow()"><i class="icon_16 icon_application_white mr10"></i>立即申请</a>
			<a class="btn_gold pl15" onclick="addBasket()"><i class="icon_16 icon_basket_white mr10"></i>加入资源车</a>
		</div>
	</div>
	...
	<div class="tab_main">
		<div data-tab-item="details" class="tab_content">
			...
			<div class="tab_content_main">
				<div data-item="service" style="width:710px;font-size: 12px;display:none;">
				...
				<div data-item="dataField" style="width:710px;font-size: 12px;">
				...
				<div data-item="file" style="width:710px;font-size: 12px;display:none;">
