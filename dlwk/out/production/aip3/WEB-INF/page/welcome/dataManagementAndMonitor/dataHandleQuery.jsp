...
<mdp:mdpHeader title="处理数据查看" curItem="management"/>
<section style="margin-top:40px;color: #000;">
	<iframe width="100%" style="height:calc(100% - 40px)" scrolling="yes" frameborder="0" id="iframe" onload="iframeLoad();"
			src="${ctx}/mdp/dms/dataProcessInfo/index.html"></iframe>
</section>
<script>
	function iframeLoad(){
		document.getElementById("iframe").contentWindow.document.body.style.marginTop = "20px";
	}
</script>
<style>
	.foot{
