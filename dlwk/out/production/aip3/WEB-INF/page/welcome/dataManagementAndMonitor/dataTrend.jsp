...
<mdp:mdpHeader title="数据成果视角" curItem="management"/>
<section style="margin-top:40px;color: #000;overflow:hidden;" >
    <iframe width="100%" style="height:calc(100% - 40px)" scrolling="yes" frameborder="0" id="iframe" onload="iframeLoad();"
            src="${ctx}/mdp/dms/dataVeiw/count.html"></iframe>
</section>
<script>
	function iframeLoad(){
		document.getElementById("iframe").contentWindow.document.body.style.margin = "20px 0 20px 20px";
		document.getElementById("iframe").contentWindow.document.getElementById("selectYear").style.marginTop = "0";
	}
</script>
<style>
	.foot{
