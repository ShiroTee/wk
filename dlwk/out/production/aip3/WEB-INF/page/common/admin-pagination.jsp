...
<link type="text/css" rel="stylesheet" href="${ctx}/resources/jquery/plugins/JqueryPagination/css/mricode.pagination.css"></link>
<script type="text/javascript" src="${ctx}/resources/jquery/plugins/JqueryPagination/js/jquery.pagination-1.2.7.js"></script>
