...
<mdp:newHeader title="API数据服务申请"  curItem="information"/>
<link rel="stylesheet" href="${ctx}/page/newWelcome/api/css/page.css"/>
<script src="${ctx}/page/newWelcome/api/js/page.js"></script>
<script src="${ctx}/page/newWelcome/api/js/index.js"></script>
<style>
	a:focus, a:hover {
    	color: inherit;
...
<div class="main_head">
	<div class="main_head_container">
		...
		<form onsubmit="return false;" class="head_search">
			<input name="" type="text" id ="search_condition" placeholder="请输入关键词" class="search_input"  autocomplete="off">
	...
	<div class="filter_box">
		...
		<div class="filter_content" style="display:none;">
			...
			<div class="filter_line">
				...
				<div class="filter_list" id="topic">
					
				</div>
			</div>
		</div>
	</div>	
    <div id="apiList" class="card_box">	
	</div>	
