...
<head>
	...
	<link rel="stylesheet" href="${ctx }/resources/font-awesome-4.3.0/css/font-awesome.min.css"/>
	
	<link rel="stylesheet" href="${ctx }/resources/css/lib-2.4.css"/>
	<link rel="stylesheet" href="${ctx}/resources/css/imgShift.css">
    <link rel="stylesheet" href="${ctx }/page/newWelcome/base/css/front-base.css" />
    <link rel="stylesheet" href="${ctx }/page/newWelcome/base/css/custom-icon.css" />
    <!-- <script type="text/javascript" src="${ctx }/page/base/js/common.js"></script> -->
    <script type="text/javascript" src="${ctx }/page/newWelcome/base/js/common.js"></script>
...
<div id="head" class="head">
	...
	<ul class="head_right">		
		...
		<li class="theme_op_container">
			<a class="theme_op_target" href="javascript:void(0);"><i class="fa fa-picture-o fa-lg"></i></a>
			<ul class="theme_op_box">
				<li>
					<a href="javascript:toggleTheme('welcome');">风格1</a>
				</li>
				<li class="cur">
					<a href="javascript:void(0);">风格2</a>
				</li>
			</ul>
		</li>
		<li class="login">
			...
			%>
				...
				<div class="user_op_container">
					<a class="user_op_target" style="margin-bottom: 10px;" href="javascript:void(0);"><%=user.getName() %></a>
	...
	<ul>
		...
		<li <c:if test="${curItem=='mulu' }">class="cur"</c:if>>
			<i class="icon icon_dropdown_arrow"></i>
		...
		<li data-item="entity" <c:if test="${curItem=='information' }">class="cur"</c:if>>
			<i class="icon icon_dropdown_arrow "></i>
