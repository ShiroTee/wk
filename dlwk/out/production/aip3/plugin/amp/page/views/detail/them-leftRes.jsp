	...
	<div class="widget-body">
		...
		<tbody>
			...
			<tr>
			    ...
			    <td class="desc-content"><span id="keyword"></span></td>
			    <td class="desc-laebl">在线链接地址：</td>
			    <td class="desc-content"><span id="resOnline"></span></td>
			</tr>
			<tr>
			    <td class="desc-laebl"> 架构类别：</td>
			    <td class="desc-content"><span id="archCateName"></span></td>
			    <td class="desc-laebl">所属主题：</td>
			    <td class="desc-content"><span id="sbjName"></span></td>
			</tr>
			<tr>
			    <td class="desc-laebl">共享级别：</td>
			    <td class="desc-content"><span id="pubName"></span></td>
			    <td class="desc-laebl">保密级别：</td>
			    <td class="desc-content"><span id="sbjName"></span></td>
			</tr>
			<tr>
			    <td class="desc-laebl">主题分类：</td>
			    <td class="desc-content" colspan="3"><span id="subCatName"></span></td>
			</tr>
			<tr class="text-area-tr">
			    <td class="desc-laebl">信息资源摘要：</td>
			    <td class="desc-content"  colspan="5"><span class="txtArea" id="abstract"></span></td>
			</tr>
		</tbody>
	</table>
			<!-- <div class="row">
				<div class="col-md-6">
					<label class="col-sm-6 "> 信息资源标识符： </label> <input
						...
						class="col-xs-10 col-sm-6 input-sm" readOnly="true" />

				</div>
				<div class="col-md-6">
					<label class="col-sm-6 "> 发布日期： </label> <input
						type="text" id="pubDt" class="col-xs-10 col-sm-6 input-sm"
						readOnly="true" name="pubDt"/>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-6">
					<label class="col-sm-6 "> 信息资源名称： </label> <input
						...
						class="col-xs-10 col-sm-6 input-sm" readOnly="true" name="assetNm"/>

				</div>
				<div class="col-md-6">
					<label class="col-sm-6 "> 信息资源提供方： </label> <input
						type="text" id="providerName"
						class="col-xs-10 col-sm-6 input-sm" readOnly="true" name="providerName"/>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<label class="col-sm-6 "> 在线链接地址： </label> <input
						type="text" id="resOnline"
						class="col-xs-10 col-sm-6 input-sm" readOnly="true" name="resOnline"/>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="input-group" style="margin-left: 8px">
						...
						<textarea id="abstract" rows="3" class="form-control"
							readonly="true" style="background: white;" name="abstract"></textarea>
					</div>
				</div>
			</div> -->
		</div>
